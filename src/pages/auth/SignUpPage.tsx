            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div className="flex items-start gap-2.5 py-1 px-1">
                <input
                  ...
                  className="mt-0.5 w-4 h-4 rounded border-slate-350 text-[#006877] focus:ring-[#006877]/20 transition-all cursor-pointer accent-[#006877]"
                  required
                />
                <label htmlFor="agreedToTerms" className="text-xs text-slate-500 font-medium leading-relaxed select-none cursor-pointer">
                  I agree to the{' '}
                  <Link to="/terms" className="text-[#006877] font-bold hover:underline">
                    Terms of Use
                  </Link>{' '}
                  and{' '}
                  <Link to="/privacy" className="text-[#006877] font-bold hover:underline">
                    Privacy Policy
                  </Link>
                </label>
              </div>
